    ...
    <div className="min-h-dvh bg-slate-50 text-slate-800">
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-3 px-4 py-2 sm:px-5 lg:px-6">
          <Link className="flex min-w-0 items-center gap-2.5" to="/" aria-label="WebBlueprint home">
            ...
            <span className="min-w-0">
              ...
              <span className="hidden truncate text-[11px] text-slate-500 sm:block">Applications before infrastructure</span>
            </span>
          </Link>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-[1440px] flex-col gap-3 px-4 py-5 text-sm text-slate-500 sm:px-5 md:flex-row md:items-center md:justify-between lg:px-6">
          <div>
            ...
            <p className="mt-0.5 text-xs">Reusable frontends, navigable proposals and application composition.</p>
          </div>
          <div className="flex flex-wrap gap-x-4 gap-y-1.5 text-xs sm:text-sm">
            <Link className="hover:text-brand-700" to="/apps">Applications</Link>
            <Link className="hover:text-brand-700" to="/docs">Documentation</Link>
            <Link className="hover:text-brand-700" to="/login">Composer access</Link>
          </div>
        </div>
      </footer>
    </div>
